...
from sfa.rspecs.elements.resource import Resource
...
from sfa.unigetestbed.unigetestbedxrn import unigetestbedXrn, hostname_to_urn, hrn_to_unigetestbed_slicename, slicename_to_hrn

from sfa.storage.model import SliverAllocation
import time


class unigetestbedAggregate:
    ...
    def get_slivers(self, urns, options={}):
        ...
        for urn in urns:
            ...
            if xrn.type == 'sliver':
                ...
                slice_names.add(xrn.unigetestbed_slicename())
        ...
        if not slices:
            return []
        slice = slices[0]
        slice['hrn'] = unigetestbedXrn(auth=self.driver.hrn, slicename=slice['slice_name']).hrn
